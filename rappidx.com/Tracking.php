...
// Delhivery Bulky Tracking Order
}elseif($couriername=="Bluedart"){
// Bluedart Tracking Order

    $bdawbstatus = "SELECT * FROM `spark_single_order` WHERE `Awb_Number`='$airwaybillnumber'  ORDER BY `Single_Order_Id` DESC";
    $bdawbstatu = mysqli_query($conn,$bdawbstatus);
    $bdawbstat = mysqli_fetch_assoc($bdawbstatu);
    $ordertype = $bdawbstat['Order_Type'];
    $StatusDate = $bdawbstat['Last_Stamp_Date'];
    $status = $bdawbstat['order_status_show'];
    $statusremark = $bdawbstat['order_status1'];
    $finaldestination = $bdawbstat['City'];
...
<thead style="background-color:#243c4f;color:#60baaf">
  <tr>
    <th style="border-right:1px solid #41AEAF;"><?= $foril ?>.Shipping_ID</th>
    ...
    <th style="border-right:1px solid #41AEAF;">Last_Status</th>
...
<thead style="background-color:#243c4f;color:#60baaf">
  <tr>
    ...
    <th style="border-right:1px solid #41AEAF;">Type</th>
    <th style="border-right:1px solid #41AEAF;">Status</th>
    <th style="border-right:1px solid #41AEAF;">Remark</th>
    <th style="border-right:1px solid #41AEAF;">Last_Status</th>
    <th style="">Destination</th>
  </tr>
</thead>
...
?>
    <div class="alert text-center" style="background-color:#60baaf" role="alert">
        <h3 style="color:#fff"><?= $airwaybillnumber ?> AWB Number Not Found ! - Please Check Again</h3>
    </div>
...
.form_righ, .my-form-border {
  position: relative;
  border-top: 10px solid #ffe141 !important;
}
</style>
