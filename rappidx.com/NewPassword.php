...
if($result1['Active'] != 1){
  echo "<script>window.location.assign('Login.php?error=noaterror')</script>";
}elseif($result1['forgetpassword'] != 1){
  echo "<script>window.location.assign('ForgetPassword.php?error=psnotforget')</script>";
}
?>
...
<form method="post" action="NewPasswordCheck.php">
