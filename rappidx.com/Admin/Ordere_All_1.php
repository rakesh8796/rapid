...
<div class="row" id="TodayOrders" style="display:none;">
    <a href="Ordere_All_Excel.php?OrderManageBy=Today" class="btn" style="font-size:15px"><u>Download Today Orders</u></a>
</div>
<!-- 24/Today Orders  End-->
<!-- This Month Orders Start -->
<div class="row" id="CurrentMonth" style="display:none;">
    <a href="Ordere_All_Excel.php?OrderManageBy=Current" class="btn" style="font-size:15px"><u>Download Current Month Order</u></a>
</div>
<!-- This Month Orders End -->
<!-- Last Month Orders Start -->
<div class="row" id="LastMonth" style="display:none;">
    <a href="Ordere_All_Excel.php?OrderManageBy=Last" class="btn" style="font-size:15px"><u>Download Last Month Order</u></a>
</div>
<!-- Last Month Orders End -->
<!-- Custom Orders Start -->
<div class="row" id="CustomOrders" style="display:none;">
    <form action="Ordere_All_Excel.php" action="POST">
        ...
        <div class="col-md-12 col-sm-12 text-center">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <input type="submit" name="downloadfile" value="Download" class="btn btn-info" style="width:100%;border-color:#60baaf;background-color:#60baaf;border-radius:20px">
                </div>
            </div>
        </div>
    </form>
