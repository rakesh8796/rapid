...
if(val == "AllDays"){
    ...
    $.ajax({
    type: "GET",
    url: 'DashboardDetailsc/AdminChangeDatas.php',
...
//  - - - - -
    ...
    if(val == "CurrentMonthFilter"){
        ...
        $.ajax({
        type: "GET",
        url: 'DashboardDetailsc/AdminChangeDatasCurtMonth.php',
    ...
    if(val == "LastMonthFilter"){
        ...
        $.ajax({
        type: "GET",
        url: 'DashboardDetailsc/AdminChangeDatasLastMonth.php',
...
// Delivered Orders
    $.ajax({
    type: "GET",
    url: 'DashboardDetailsc/AdminDelivered.php',
...
// Shipment Weight Orders
    $.ajax({
    type: "GET",
    url: 'DashboardDetailsc/AdminShipmentWeightGraph.php',
...
// Performance Orders
    $.ajax({
    type: "GET",
    url: 'DashboardDetailsc/AdminPerformanceGraph.php',
    data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Shipment ",selectedname:selectedname},
    success: function (data){
...
// Volume Trend Orders
    $.ajax({
    type: "GET",
    url: 'DashboardDetailsc/AdminVolumeGraph.php',
...
<script type="text/javascript">
$(document).ready(function(){
  $(".notshowdatatdcw").html("<center><img src='DashboardDetailsc/loader.gif' alt='Loading...' style='width:20px'></center>");
  // alert('work');
// Today Orders
  $.ajax({
  type: "GET",
  url: 'DashboardDetailsc/AdminToday.php',
  data:{val:"Today "},
  success: function (data){
...
<?php
    ...
    $nextwednesdaydate1 = date('d-m-Y', strtotime($nextwednesdaydate));
    ...
    <i class="fa fa-money" aria-hidden="true" style="background-color:#A1A1A1 !important;width:41px;height:41px;padding:8px 0px 0px 0px"></i>
            <div class="bodystate fontweigh">
                <a href="Remittance.php">
                  ...
                  <span class="text-muted" style="font-size:13px">COD Balance</span><span style="font-size:9px"><u> <?= $nextwednesdaydate1 ?></u></span><br>
                </a>
...
$(document).ready(function(){
  // alert('work');
  $(".notshowdatatcl").html("<center><img src='DashboardDetailsc/loader.gif' alt='Loading...' style='width:30px'></center>");
...
// Current Month
  $.ajax({
  type: "GET",
  url: 'DashboardDetailsc/AdminCurrentMonth.php',
  data:{val:"Today "},
  success: function (data){
...
// Last Month
  $.ajax({
  type: "GET",
  url: 'DashboardDetailsc/AdminLastMonth.php',
  data:{val:"Today "},
  success: function (data){
...
$(document).ready(function(){
  // alert('work');
    $(".notshowdataspv").html("<img src='DashboardDetailsc/loader.gif' alt='Loading...' style='width:50px'>");
    var enddatefrom = $("#todaydatecal").val();
    var startdatefrom = $("#todaydatecal").val();
// Shipment Weight Orders
    $.ajax({
