...
<div class="col-md-12 text-left">
      <div class="col-md-3 col-sm-3"><span style="font-size:18px"><u><b>Pending Orders</b></u></span></div>
      <div class="col-md-3 col-sm-3"></div>
      <div class="col-md-3 col-sm-3"></div>
      <div class="col-md-3 col-sm-3">
          <a href="OrderaAllExcel/Client_Pending_Excel.php" class="btn btn-default" style="border-radius:20px;background:#5A5A5A;color:#fff;width:90%">Download</a>
      </div>
</div><br>&ensp;
<!-- Excel File -->
  ...
  <table id="myTable" class="table table-striped">
      ...
      <tbody>
        ...
        <?php
            $singleproquery = "SELECT * FROM `spark_single_order` WHERE `User_Id`='$user_id' AND `Awb_Number`!='' AND `order_status1`='Pending'";
