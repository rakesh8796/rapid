      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          <div class="buttons ">
            ...
            <a href="#" class="btn btn-icon icon-left btn-primary " style="background-color:#00cc00;
                      border-radius: 5%;"><i class="fa fa-exclamation" style="font-size: 17px;"></i>&nbsp;Recharge</a>
                ...
                <div class="card ">
                  ...
                  <div class="row ">
                    <div class="col-md-4 my-3">
                      <h6 style="margin-left:20%"><strong>Serviceable Pincodes</strong></h6>
                    </div>
                    <div class="col-md-3 my-2">
                      
                      <a href="#" class="btn btn-info btn-primary   " >Download Serviceable PinCode</a>
                    </div>
                    <div class="col-md-1"></div>
                    <div class="col-md-4 my-2">
                      <input type="text" onkeyup="checkpincode(this.value)" class="form-control" placeholder="Search Pincode " >
                    </div>
