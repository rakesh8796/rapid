...
$bannername = $fa.$fb.$fc.$randno1.$randno2.".csv";
                ...
                ) VALUES ('Standard','$bannername','$tudate','$crttime','$crtdatetime','$user_id','$user_id','$user_id','$totalnooforders')";
...
$singlequery = "INSERT INTO `spark_mis_report_file`(
  `couriername`,`filename`, `uploaddate`, `uploadtime`, `uploaddatetime`, `uploadby`,`uploadid`, `uploadusercate`, `totalnooforders`
) VALUES ('XpressBees','$bannername','$tudate','$crttime','$crtdatetime','$user_id','$user_id','$user_id','$totalnooforders')";
mysqli_query($conn,$singlequery);
...
$singlequery = "INSERT INTO `spark_mis_report_file`(
  `couriername`,`filename`, `uploaddate`, `uploadtime`, `uploaddatetime`, `uploadby`,`uploadid`, `uploadusercate`, `totalnooforders`
) VALUES ('Delhivery','$bannername','$tudate','$crttime','$crtdatetime','$user_id','$user_id','$user_id','$totalnooforders')";
mysqli_query($conn,$singlequery);
