...
<!-- <div class="col-md-3 col-sm-3">
    <a href="mis_report_emp_excel.php" class="btn btn-info btn-block">Download</a>
</div> -->
<!-- Excel File -->
...
<h3 class="panel-title text-center fontweighlight" style="font-size:14px !important;background:#b5b5b5;border-radius:20px;color:#333131">&ensp;&ensp;Upload MIS Report in CSV Format</h3>
</div>
