...
`order_cancel` IS NULL AND `delivereddate` BETWEEN '$crtmonth' AND '$crtmonth'";
    $singleproqueryr=mysqli_query($conn,$singleproquery);
    while($row = mysqli_fetch_assoc($singleproqueryr))
    {
?>
...
`order_cancel` IS NULL AND `rtodate` BETWEEN '$crtmonth' AND '$crtmonth'";
    $singleproqueryr=mysqli_query($conn,$singleproquery);
    while($row = mysqli_fetch_assoc($singleproqueryr))
    {
?>
