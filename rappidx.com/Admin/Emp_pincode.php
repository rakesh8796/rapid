...
<div class="row bg-title">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4 class="page-title">Pincode Servieables</h4>
  </div>
</div>
...
<div class="col-md-12">
   <div class="col-md-12">
       <div class="panel">
           <div class="panel-heading" style="background:#33333373;padding:10px">
               <h5 style="font-weight:500">Upload Pincodes With Excel(CSV) File</h5>
...
echo "<script> window.location.assign('Emp_pincode.php?excelfile=Update')</script>";
// exit();
//
} catch (Exception $e) {
echo "<script> window.location.assign('Emp_pincode.php?excelfile=No Update')</script>";
}
...
<div class="col-md-12">
  <div class="col-md-12">
      <div class="panel filterable">
        ...
        <div class="panel-heading" style="background:#33333373;padding:10px">
            <h5 style="font-weight:500">Serviceable Pincode Lists</h5>
          </div>
<div class="panel-body">
