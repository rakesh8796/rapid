...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://maps.googleapis.com/maps/api/distancematrix/json?destinations=".$pincodedis."&origins=".$pincodeori."&key=AIzaSyChLdtsgkds1xjbwfdT6pNvK8rPO-2K6_o",
...
// echo " - ";
$distancemetx = $distancenmetrix[1];


  // echo "<br>";
  // echo "Estimate Time : ".$estimatetime;

echo $status = $distanceonly;
