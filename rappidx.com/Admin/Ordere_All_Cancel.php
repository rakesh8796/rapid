...
<div class="bg-title">
    <div class="col-md-12">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">All Cancel Orders</h4>
        </div>
    </div>
</div>
...
<div class="col-md-3 col-sm-3">
    <a href="Order_All_Cancel_Excel.php" class="btn btn-info btn-block">Download</a>
</div> -->
<!-- Excel File -->
...
<!--  -->
<?php
    $singleproquery = "SELECT * FROM `spark_single_order` WHERE `order_cancel`='1' ORDER BY `Single_Order_Id` DESC";
