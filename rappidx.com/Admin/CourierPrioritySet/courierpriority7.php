...
function courierprioritysetseven(val){
    ...
    var sixthhcourier = $("#sixthhcourier").val();
    
    $.ajax({
    type: "GET",
    url: 'CourierPrioritySet/courierpriority8.php',
    data:{courierselect:val,firstcourier:firstcourier,secondcourier:secondcourier,thirdcourier:thirdcourier,fourthcourier:fourthcourier,fifthcourier:fifthcourier,sixthhcourier:sixthhcourier},
