...
<input type="hidden" name="<?= $courierselect ?>" value="10">
...
<input type="text" id="tenthcourier" value="<?= $$courierselect ?>">

<select class="form-control" name="courierpriorityset5" onchange="courierpriorityseteleven(this.value)" style="float:right;border-radius:15px">
...
function courierpriorityseteleven(val){
    ...
    $.ajax({
    type: "GET",
    url: 'CourierPrioritySet/courierpriority12.php',
    data:{courierselect:val,firstcourier:firstcourier,secondcourier:secondcourier,thirdcourier:thirdcourier,fourthcourier:fourthcourier,fifthcourier:fifthcourier,sixthhcourier:sixthhcourier,seventhcourier:seventhcourier,eighthcourier:eighthcourier,ninethcourier:ninethcourier,tenthcourier:tenthcourier},
