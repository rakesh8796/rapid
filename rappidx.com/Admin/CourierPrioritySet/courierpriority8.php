...
<input type="hidden" id="sixthhcourier" value="<?= $sixthhcourier ?>">
<input type="hidden" id="seventhhcourier" value="<?= $courierselect ?>">

<select class="form-control" name="courierpriorityset5" onchange="courierpriorityseteight(this.value)" style="float:right;border-radius:15px">
<option value="0">Courier Priority 8</option>
<?php
...
function courierpriorityseteight(val){
    ...
    $.ajax({
    type: "GET",
    url: 'CourierPrioritySet/courierpriority9.php',
    data:{courierselect:val,firstcourier:firstcourier,secondcourier:secondcourier,thirdcourier:thirdcourier,fourthcourier:fourthcourier,fifthcourier:fifthcourier,sixthhcourier:sixthhcourier,seventhcourier:seventhcourier},
    success: function (data){
        $("#courierprioritynine").html(data);
    },
    error: function (data) {
