    ...
    <div class="container">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">All Retailers</h4> </div>
...
<table id="myTable" class="table table-striped">
    ...
    <tbody>
      ...
      // $user_id = 4;
      $allclientquery = "SELECT * FROM `asitfa_user` WHERE `usertype`='retailer' ORDER BY `User_Id` DESC";
      ...
      function docstatus(valis){
          ...
          <td>
            ...
            //   if(empty($row['User_Email'])){
              ?>
                  <!--<a href="Client_Edita_Commerical.php?email=<?= $row['Company_Name'] ?>&id=<?= $row['Reg_Mobile'] ?>&m=<?= $row['User_Id'] ?>&n=<?= $row['User_Email'] ?>" target="_blank" title="EDIT Retailer Details">-->
                  <!--    <i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size:18px"></i>-->
                  <!--</a>-->
              <?php
            //   }else{
              ?>
                  <a href="retailer_edit.php?email=<?= $row['Company_Name'] ?>&id=<?= $row['Reg_Mobile'] ?>&m=<?= $row['User_Id'] ?>&n=<?= $row['User_Email'] ?>" target="_blank" title="EDIT Retailer Details">
                      <i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size:18px"></i>
                  </a>
              <?php
            //   }
              ?>
              &ensp;&ensp;
              <a href="retailer_permissions.php?email=<?= $row['Company_Name'] ?>&id=<?= $row['Reg_Mobile'] ?>&m=<?= $row['User_Id'] ?>&n=<?= $row['User_Email'] ?>" target="_blank" title="Retailer Permissions Details">
