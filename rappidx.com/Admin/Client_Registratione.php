...
<form class="grid-form" enctype="multipart/form-data"  method="post" action="Client_Registratione.php">
...
";
    $mail->send();
//  *   *   *    Mail Send To Client *  *   *
    echo "<script>window.location.assign('Client_Registratione.php?msg=y')</script>";
}catch (Exception $e) {
    echo "<script>window.location.assign('Client_Registratione.php?msg=n')</script>";
}
