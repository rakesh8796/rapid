...
?>
    ...
    <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-people p-r-10"></i> <span class="hide-menu"> Franchise <span class="fa arrow"></span></span></a>
        <ul class="nav nav-second-level">
            <li> <a href="Retailer_Registration.php">Franchise Register</a> </li>
            <li> <a href="Retailer_All.php">All Franchises</a> </li>
        </ul>
    </li>
...
if($permission['emp_mis_show']){
    if($permission['emp_mis_delete']==1){
...
?>
<li> <a href="javascript:void(0);" class="waves-effect"><i class="ti-calendar p-r-10"></i> <span class="hide-menu"> Orders off <span class="fa arrow"></span></span></a>
    <ul class="nav nav-second-level">
...
<li> <a href="Rcalculator.php" class="waves-effect"><i data-icon="P" class="fa fa-calculator p-r-10"></i> <span class="hide-menu">Calculator off</span></a> </li>

<!--  -->
<?php
// if($permission['billing_show']){    // Upload Orders
?>
<li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user-md p-r-10"></i> <span class="hide-menu"> Upload Orders aa <span class="fa arrow"></span></span></a>
<ul class="nav nav-second-level">
<?php
...
<li> <a href="Rcalculator.php" class="waves-effect"><i data-icon="P" class="fa fa-calculator p-r-10"></i> <span class="hide-menu">Calculator off</span></a>
<?php
} // Reports
?>
<!--  -->
...
if($permission['reports_show']){    // Report
?>
<li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-chart p-r-10"></i> <span class="hide-menu"> Reports Act<span class="fa arrow"></span></span></a>
<ul class="nav nav-second-level">
<?php
if($permission['mis_show']){
  echo "<li> <a href='mis_report_client.php'>MIS</a></li>";
...
<li> <a href="Rcalculator.php" class="waves-effect"><i data-icon="P" class="fa fa-calculator p-r-10"></i> <span class="hide-menu">Calculator</span></a>
<?php
} // Reports
?>
<!--  -->
