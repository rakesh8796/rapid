...
if(!empty($startdatefrom) AND !empty($enddatefrom)){
    $filename = $username."-".$startdatefrom."_".$enddatefrom."_All Orders";
}else{    $filename = $username."-"."All Orders"; }
...
// Attempt Count
if($row['order_status_show']=="Manifested" OR $row['order_status_show']=="Cancellation Requested By Client"){
    continue;
}
// Attempt Count
// Order Cancel Or Not
