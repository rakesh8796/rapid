...
<div class="row bg-title">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4 class="page-title">Current Month Orders
      <span style="float:right">
        <!-- Excel File -->
          <a href="Order_Current_Month_Excel.php" class="btn btn-info btn-block">Download Current Month Orders</a>
        <!-- Excel File -->
      </span>
    </h4>
  </div>
...
<div class="table-responsive">
  <table id="myTable" class="table table-striped">
      ...
      <tbody>
        ...
        <?php
            $singleproquery = "SELECT * FROM `spark_single_order` WHERE `User_Id`='$user_id' AND `Rec_Time_Stamp`>now() - INTERVAL 30 day ORDER BY `Single_Order_Id` DESC";
