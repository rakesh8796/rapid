...
`Beneficiaryname`='$beneficiaryname',`Bankname`='$bankname',`Bankaccount`='$bankacc',`Branch`='$branch',`IFSC`='$ifsc',`Acc_Type`='$acctype',
...
if($min1_a){
	$query1 = "INSERT INTO `asitfa_user`(`usertype`,`Company_Name`,`Website`,`Brand`,`Email`,`Pan`,`Tan`,`GST_No`,`Reg_Address`,`Reg_City`,`Reg_Pin`,`Reg_Mobile`,`Reg_Landline`,`Com_Address`,`Com_City`,`Com_Pin`,`Com_Mobile`,`Com_Landline`,`Beneficiaryname`,`Bankname`,`Bankaccount`,`Branch`,`IFSC`,`Acc_Type`,`Product`,`Service`,`Pickup`,`Cod_Rem`,`Billing_Type`,`Billing_Cycle`,`remittancecycle`,`commercialstype`,`min1_a`,`min1_b`,`min1_c`,`min1_d`,`min1_e`,`add1_a`,`add1_b`,`add1_c`,`add1_d`,`add1_e`,`Rto1_a`,`Rto1_b`,`Rto1_c`,`Rto1_d`,`Rto1_e`,`FSC1`,`COD1`,`Shipment_Lia1`,`GST1`,`specialnotes1`,`Client_Auth`,`Designation`,`Client_Email`,`Client_Mobile`,`Client_poc`,`Poc_Designation`,`Poc_Email`,`Poc_Mobile`,`Operation_Poc`,`Operation_Designation`,`Operation_Mail`,`Operation_Mobile`,`Bd_Name`,`Bd_Designation`,`Bd_mail`,`Bd_Mobile`,`Pancard`,`GST_cert`,`Can_Cheque`,`Add_Proofe`,`Client_Mail_acc`,`foldername`,`Rec_Time_Stamp`,`Active`,`added_by`) VALUES ('client','$companyname','$website','$brand','$Email','$pan','$tan','$gstno','$regaddress','$regcity','$regpin','$regmobile','$reglandline','$comaddress','$comcity','$compin','$commobile','$comlandline','$beneficiaryname','$bankname','$bankacc','$branch','$ifsc','$acctype','$product','$service','$pickup','$codrem','$billingtype','$billingcycle','$remittancecycle','kg1','$min1_a','$min1_b','$min1_c','$min1_d','$min1_e','$add1_a','$add1_b','$add1_c','$add1_d','$add1_e','$rto1_a','$rto1_b','$rto1_c','$rto1_d','$rto1_e','$fsc1','$cod1','$shipmentlia1','$gst1','$specialnote1','$clientauth','$designation','$clientemail','$clientmobile','$clientpoc','$pocdesignation','$pocemail','$pocmobile','$operationpoc','$operationdesignation','$operationemail','$operationmobile','$bdname','$bddesignation','$bdemail','$bdmobile','$uploadimagename','$gstcername','$canchequename','$addproofename','$clientmailaccname','$foldername',now(),'1','Admin')";
	mysqli_query($conn,$query1);
...
if($min2_a){
	$query2 = "INSERT INTO `asitfa_user`(`usertype`,`Company_Name`,`Website`,`Brand`,`Email`,`Pan`,`Tan`,`GST_No`,`Reg_Address`,`Reg_City`,`Reg_Pin`,`Reg_Mobile`,`Reg_Landline`,`Com_Address`,`Com_City`,`Com_Pin`,`Com_Mobile`,`Com_Landline`,`Beneficiaryname`,`Bankname`,`Bankaccount`,`Branch`,`IFSC`,`Acc_Type`,`Product`,`Service`,`Pickup`,`Cod_Rem`,`Billing_Type`,`Billing_Cycle`,`remittancecycle`,`commercialstype`,`min2_a`,`min2_b`,`min2_c`,`min2_d`,`min2_e`,`add2_a`,`add2_b`,`add2_c`,`add2_d`,`add2_e`,`Rto2_a`,`Rto2_b`,`Rto2_c`,`Rto2_d`,`Rto2_e`,`FSC2`,`COD2`,`Shipment_Lia2`,`GST2`,`specialnotes2`,`Client_Auth`,`Designation`,`Client_Email`,`Client_Mobile`,`Client_poc`,`Poc_Designation`,`Poc_Email`,`Poc_Mobile`,`Operation_Poc`,`Operation_Designation`,`Operation_Mail`,`Operation_Mobile`,`Bd_Name`,`Bd_Designation`,`Bd_mail`,`Bd_Mobile`,`Pancard`,`GST_cert`,`Can_Cheque`,`Add_Proofe`,`Client_Mail_acc`,`foldername`,`Rec_Time_Stamp`,`Active`,`added_by`) VALUES ('client','$companyname','$website','$brand','$Email','$pan','$tan','$gstno','$regaddress','$regcity','$regpin','$regmobile','$reglandline','$comaddress','$comcity','$compin','$commobile','$comlandline','$beneficiaryname','$bankname','$bankacc','$branch','$ifsc','$acctype','$product','$service','$pickup','$codrem','$billingtype','$billingcycle','$remittancecycle','kg2','$min2_a','$min2_b','$min2_c','$min2_d','$min2_e','$add2_a','$add2_b','$add2_c','$add2_d','$add2_e','$rto2_a','$rto2_b','$rto2_c','$rto2_d','$rto2_e','$fsc2','$cod2','$shipmentlia2','$gst2','$specialnote2','$clientauth','$designation','$clientemail','$clientmobile','$clientpoc','$pocdesignation','$pocemail','$pocmobile','$operationpoc','$operationdesignation','$operationemail','$operationmobile','$bdname','$bddesignation','$bdemail','$bdmobile','$uploadimagename','$gstcername','$canchequename','$addproofename','$clientmailaccname','$foldername',now(),'1','Admin')";
	mysqli_query($conn,$query2);
...
if($min5_a){
	$query5 = "INSERT INTO `asitfa_user`(`usertype`,`Company_Name`,`Website`,`Brand`,`Email`,`Pan`,`Tan`,`GST_No`,`Reg_Address`,`Reg_City`,`Reg_Pin`,`Reg_Mobile`,`Reg_Landline`,`Com_Address`,`Com_City`,`Com_Pin`,`Com_Mobile`,`Com_Landline`,`Beneficiaryname`,`Bankname`,`Bankaccount`,`Branch`,`IFSC`,`Acc_Type`,`Product`,`Service`,`Pickup`,`Cod_Rem`,`Billing_Type`,`Billing_Cycle`,`remittancecycle`,`commercialstype`,`min5_a`,`min5_b`,`min5_c`,`min5_d`,`min5_e`,`add5_a`,`add5_b`,`add5_c`,`add5_d`,`add5_e`,`Rto5_a`,`Rto5_b`,`Rto5_c`,`Rto5_d`,`Rto5_e`,`FSC5`,`COD5`,`Shipment_Lia5`,`GST5`,`specialnotes5`,`Client_Auth`,`Designation`,`Client_Email`,`Client_Mobile`,`Client_poc`,`Poc_Designation`,`Poc_Email`,`Poc_Mobile`,`Operation_Poc`,`Operation_Designation`,`Operation_Mail`,`Operation_Mobile`,`Bd_Name`,`Bd_Designation`,`Bd_mail`,`Bd_Mobile`,`Pancard`,`GST_cert`,`Can_Cheque`,`Add_Proofe`,`Client_Mail_acc`,`foldername`,`Rec_Time_Stamp`,`Active`,`added_by`) VALUES ('client','$companyname','$website','$brand','$Email','$pan','$tan','$gstno','$regaddress','$regcity','$regpin','$regmobile','$reglandline','$comaddress','$comcity','$compin','$commobile','$comlandline','$beneficiaryname','$bankname','$bankacc','$branch','$ifsc','$acctype','$product','$service','$pickup','$codrem','$billingtype','$billingcycle','$remittancecycle','kg5','$min5_a','$min5_b','$min5_c','$min5_d','$min5_e','$add5_a','$add5_b','$add5_c','$add5_d','$add5_e','$rto5_a','$rto5_b','$rto5_c','$rto5_d','$rto5_e','$fsc5','$cod5','$shipmentlia5','$gst5','$specialnote5','$clientauth','$designation','$clientemail','$clientmobile','$clientpoc','$pocdesignation','$pocemail','$pocmobile','$operationpoc','$operationdesignation','$operationemail','$operationmobile','$bdname','$bddesignation','$bdemail','$bdmobile','$uploadimagename','$gstcername','$canchequename','$addproofename','$clientmailaccname','$foldername',now(),'1','Admin')";
	mysqli_query($conn,$query5);
...
if($min10_a){
	$query10 = "INSERT INTO `asitfa_user`(`usertype`,`Company_Name`,`Website`,`Brand`,`Email`,`Pan`,`Tan`,`GST_No`,`Reg_Address`,`Reg_City`,`Reg_Pin`,`Reg_Mobile`,`Reg_Landline`,`Com_Address`,`Com_City`,`Com_Pin`,`Com_Mobile`,`Com_Landline`,`Beneficiaryname`,`Bankname`,`Bankaccount`,`Branch`,`IFSC`,`Acc_Type`,`Product`,`Service`,`Pickup`,`Cod_Rem`,`Billing_Type`,`Billing_Cycle`,`remittancecycle`,`commercialstype`,`min10_a`,`min10_b`,`min10_c`,`min10_d`,`min10_e`,`add10_a`,`add10_b`,`add10_c`,`add10_d`,`add10_e`,`Rto10_a`,`Rto10_b`,`Rto10_c`,`Rto10_d`,`Rto10_e`,`FSC10`,`COD10`,`Shipment_Lia10`,`GST10`,`specialnotes10`,`Client_Auth`,`Designation`,`Client_Email`,`Client_Mobile`,`Client_poc`,`Poc_Designation`,`Poc_Email`,`Poc_Mobile`,`Operation_Poc`,`Operation_Designation`,`Operation_Mail`,`Operation_Mobile`,`Bd_Name`,`Bd_Designation`,`Bd_mail`,`Bd_Mobile`,`Pancard`,`GST_cert`,`Can_Cheque`,`Add_Proofe`,`Client_Mail_acc`,`foldername`,`Rec_Time_Stamp`,`Active`,`added_by`) VALUES ('client','$companyname','$website','$brand','$Email','$pan','$tan','$gstno','$regaddress','$regcity','$regpin','$regmobile','$reglandline','$comaddress','$comcity','$compin','$commobile','$comlandline','$beneficiaryname','$bankname','$bankacc','$branch','$ifsc','$acctype','$product','$service','$pickup','$codrem','$billingtype','$billingcycle','$remittancecycle','kg10','$min10_a','$min10_b','$min10_c','$min10_d','$min10_e','$add10_a','$add10_b','$add10_c','$add10_d','$add10_e','$rto10_a','$rto10_b','$rto10_c','$rto10_d','$rto10_e','$fsc10','$cod10','$shipmentlia10','$gst10','$specialnote10','$clientauth','$designation','$clientemail','$clientmobile','$clientpoc','$pocdesignation','$pocemail','$pocmobile','$operationpoc','$operationdesignation','$operationemail','$operationmobile','$bdname','$bddesignation','$bdemail','$bdmobile','$uploadimagename','$gstcername','$canchequename','$addproofename','$clientmailaccname','$foldername',now(),'1','Admin')";
	mysqli_query($conn,$query10);
...
// If ID Not Created
    ...
    echo "<script>window.location.assign('Client_Edit.php?m=$User_Id&msg=y')</script>";
}else
{
    echo "<script>window.location.assign('Client_Edit.php?m=$User_Id&msg=n')</script>";
}
