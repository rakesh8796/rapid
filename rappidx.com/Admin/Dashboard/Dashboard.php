...
$tallordersexcept = "SELECT count('Single_Order_Id') FROM `spark_single_order` WHERE `User_Id`='$checkuserids' AND `Awb_Number`!='' AND `order_cancel` IS NULL AND (`order_status_show`!='Delivered' AND `order_status_show`!='RTO Delivered') AND `Rec_Time_Date` BETWEEN '$startdatefrom' AND '$enddatefrom'";
...
// COD & PrePaid Orders
// echo "/ &ensp; Prepaid : ";
$prepaidorderscp1 = "SELECT count('Single_Order_Id') FROM `spark_single_order` WHERE `User_Id`='$checkuserids' AND `Awb_Number`!='' AND `order_cancel` IS NULL AND `Order_Type`='Prepaid' AND (`order_status_show`!='Delivered' AND `order_status_show`!='RTO Delivered') AND `Rec_Time_Date` BETWEEN '$startdatefrom' AND '$enddatefrom'";
// echo "<br><br>";
...
// echo "/ &ensp; COD : ";
$codorderscp1 = "SELECT count('Single_Order_Id') FROM `spark_single_order` WHERE `User_Id`='$checkuserids' AND `Awb_Number`!='' AND `order_cancel` IS NULL AND `Order_Type`='COD' AND (`order_status_show`!='Delivered' AND `order_status_show`!='RTO Delivered') AND `Rec_Time_Date` BETWEEN '$startdatefrom' AND '$enddatefrom'";
...
<div class="row">
    ...
    <div class="col-md-4 col-sm-12 col-xs-12">
        <div class="white-box">
            ...
            <div class="stats-row" id="currentmonthdata">
                <div class="stat-item">
    ...
    <div class="col-md-4 col-sm-12 col-xs-12">
        <div class="white-box">
            ...
            <div class="stats-row" id="lastmonthdata">
                <div class="stat-item">
