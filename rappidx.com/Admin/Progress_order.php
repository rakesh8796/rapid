...
<div class="row bg-title">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4 class="page-title">Progress Order
      <span style="float:right">
        <!-- Excel File -->
          <a href="Order_Last_7_Days_C_Excel.php" class="btn btn-info btn-block">Download All Progress Orders</a>
        <!-- Excel File -->
      </span>
    </h4>
  </div>
...
<div class="table-responsive">
  <table id="myTable" class="table table-striped">
      ...
      <tbody>
        ...
        <?php
            $singleproquery = "SELECT * FROM `spark_single_order` WHERE `User_Id`='$user_id' AND `order_status`='Progress'";
        ...
        <tr class="record">
            ...
            <td class="text-center">
                <a href="Shipping_Tracking.php?orderid=<?= $row['Single_Order_Id'] ?>&awbno=<?= $row['Awb_Number'] ?>" target="_blank" class="btn btn-primary" style="background:#60baaf;border-color:#60baaf">
                    Tracking
                </a>
            </td>
