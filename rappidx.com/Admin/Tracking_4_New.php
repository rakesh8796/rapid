...
$allawbno2 = array();
echo $livequery2 = "SELECT * FROM `autostatusupdate4` WHERE `awbcheck`='0'  ORDER BY `autostatusid` LIMIT 50";
echo "<br>";
$livequery2r = mysqli_query($conn,$livequery2);
$livecount2 = 1;
while ($livequery2res = mysqli_fetch_assoc($livequery2r)){
       $allawbno2[$livecount2] = $livequery2res['awbnois'];
       $crtno = $livequery2res['autostatusid'];
       $queryallawb = "UPDATE `autostatusupdate4` SET `awbcheck`='1' WHERE `autostatusid`='$crtno'";
...
$query123 = "INSERT INTO `testing_cronjob`(`name`, `crtdate`, `count`) VALUES ('Admin',now(),'New_4')";
