...
// Last Month
  $lstmonth = date("d-m-Y",strtotime("-1 Month"));
  // $lstmonth = date("m",strtotime("-1 Month"));
$lstmonth = date('m',strtotime($lstmonth));
  $lstyear = date("d-m-Y",strtotime("-1 Month"));
  // $lstyear = date("Y");
$lstyear = date('Y',strtotime($lstyear));
...
//  - - - - -
    ...
    if(val == "TodayDay"){
        ...
        // BlueDart Orders
          $.ajax({
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"Today"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
            console.log('Error:', data);
          }
        ...
        // Delhivery Orders
          $.ajax({
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"Today"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
            console.log('Error:', data);
          }
        ...
        // XpressBees Orders
          $.ajax({
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"Today"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
            console.log('Error:', data);
          }
    ...
    if(val == "YesterDay"){
        ...
        // BlueDart Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"Yesterday"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
        ...
        // Delhivery Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"Yesterday"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
        ...
        // XpressBees Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"Yesterday"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
    ...
    if(val == "Last7Days"){
        ...
        // BlueDart Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"Last7Days"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
        ...
        // Delhivery Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"Last7Days"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
        ...
        // XpressBees Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"Last7Days"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
    ...
    if(val == "Last30Days"){
        ...
        // BlueDart Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"Last30Days"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
        ...
        // Delhivery Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"Last30Days"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
        ...
        // XpressBees Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"Last30Days"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
    ...
    if(val == "Last90Days"){
        ...
        // BlueDart Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"Last90Days"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
        ...
        // Delhivery Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"Last90Days"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
        ...
        // XpressBees Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"Last90Days"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
    ...
    if(val == "CurrentMonthFilter"){
        ...
        // BlueDart Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"CurrentMonth"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
        ...
        // Delhivery Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"CurrentMonth"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
        ...
        // XpressBees Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"CurrentMonth"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
    ...
    if(val == "LastMonthFilter"){
        ...
        // BlueDart Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierBD.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"BlueDart ",timeperiod:"LastMonth"},
          success: function (data){
            $("#bdcourierdiv").html(data);
          },
          error: function (data) {
        ...
        // Delhivery Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierDL.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"Delhivery ",timeperiod:"LastMonth"},
          success: function (data){
            $("#dlcoureirdiv").html(data);
          },
          error: function (data) {
        ...
        // XpressBees Orders
          ...
          type: "GET",
          url: 'DashboardDetails/AdminCourierXB.php',
          data:{startdatefrom:startdatefrom,enddatefrom:enddatefrom,val:"XpressBees ",timeperiod:"LastMonth"},
          success: function (data){
            $("#xbcourierdiv").html(data);
          },
          error: function (data) {
...
<!-- BlueDart   /  Delhivery  /  XpressBees  Courier Details -->
<script type="text/javascript">
$(document).ready(function(){
  // alert('work');
  $(".notshowdatatcourier1").html("<center><img src='DashboardDetails/loader.gif' alt='Loading...' style='width:30px'></center>");
...
<div class="row">
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="white-box" id="bdcourierdiv">
      <h3 class="box-title"> BlueDart Courier</h3>
      <div class="stats-row notshowdatatcourier1">
          <!-- No Data -->
      </div>
  </div>
</div>
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="white-box" id="dlcoureirdiv">
      <h3 class="box-title"> Delhivery Courier</h3>
      <div class="stats-row notshowdatatcourier1">
        <!-- No Data -->
      </div>
  </div>
...
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="white-box" id="xbcourierdiv">
      <h3 class="box-title"> XpressBees Courier</h3>
      <div class="stats-row notshowdatatcourier1">
        <!-- No Data -->
      </div>
  </div>
...
<!-- /.row -->
<!-- BlueDart   /  Delhivery  /  XpressBees  Courier Details End-->
