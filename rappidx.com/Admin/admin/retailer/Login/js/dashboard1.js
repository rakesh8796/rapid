...
$(document).ready(function () {
    ...
    var granimInstance4 = new Granim({
     ...
     var granimInstance6 = new Granim({
        element: '#canvas-interactive6',
        name: 'interactive-gradient6',
        elToSetClassOn: '.canvas-interactive-wrapper6',
        direction: 'diagonal',
        opacity: [1, 1],
        isPausedWhenNotInView: true,
        states: {
     ...
     var granimInstance7 = new Granim({
        element: '#canvas-interactive7',
        name: 'interactive-gradient7',
        elToSetClassOn: '.canvas-interactive-wrapper7',
        direction: 'diagonal',
        opacity: [1, 1],
        isPausedWhenNotInView: true,
        states: {
     ...
     var granimInstance8 = new Granim({
        element: '#canvas-interactive8',
        name: 'interactive-gradient8',
        elToSetClassOn: '.canvas-interactive-wrapper8',
        direction: 'diagonal',
        opacity: [1, 1],
        isPausedWhenNotInView: true,
        states: {
