...
?>
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
          <!--<a href="bulkorderupload_excel.php" class="btn btn-danger btn-block">Download Unsuccess Upload Orders</a>-->
      </div>
      <div class="col-md-4">
          <a href="bulkorderupload_excel.php" class="btn btn-success btn-block">Download Successfull Place Orders</a>
        </div>
    </div>
    <!-- Excel File -->
    ...
    $singleproquery = "SELECT * FROM `spark_single_order` WHERE `User_Id` IN ($user_ids) AND `uploadtype`='Excel' AND `Rec_Time_Date`='$tdate' ORDER BY `Single_Order_Id` DESC";
    //
...
// Pickup Address
    ...
    }else
    {
        ...
        if($exists = mysqli_num_rows($alldata))
        {
            ...
            echo "<br><br>";
           $tdate = date("Y-m-d");
        $singlequery = "INSERT INTO `spark_single_order`(`Order_Type`, `User_Id`,`Name`, `Address`, `State`, `City`, `Mobile`, `Pincode`, `Item_Name`, `Quantity`, `Width`, `Height`, `Length`, `Actual_Weight`, `Total_Amount`, `Invoice_Value`, `Cod_Amount`,`additionaltype`,`Rec_Time_Date`,`uploadtype`,`pickup_id`,`Address_Id`, `pickup_name`,`pickup_mobile`,`pickup_pincode`,`pickup_gstin`,`pickup_address`,`pickup_state`,`pickup_city`,`order_status`,`order_status1`) VALUES ('$value[25]','$user_id','$value[0]','$value[1]','$value[12]','$value[13]','$value[2]','$value[3]','$value[5]','$value[6]','$value[7]','$value[8]','$value[9]','$value[15]','$value[16]','$value[10]','$value[11]','$value[12]','$tdate','Excel','$value[17]','$value[17]','$value[18]','$value[19]','$value[20]','$value[21]','$value[22]','$value[23]','$value[24]','Pending','Pending')";
