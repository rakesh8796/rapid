...
<div class="col-md-4">
    <select class="form-control" onchange="ManageOrders(this.value)" style="border-radius:20px">
        ...
        <!--<option value="YesterdayOrders">Yesterday Orders</option>-->
        ...
        <option value="ManifestOrdersIs">Manifested / Not Picked</option>
...
document.getElementById("AllOrders").style.display = "none";
            ...
            document.getElementById("YesterdayOrders").style.display = "none";
            document.getElementById("ManifestOrders").style.display = "none";
        document.getElementById("TodayOrders").style.display = "block";
    }else if(val == "YesterdayOrders"){
document.getElementById("AWBNumber").style.display = "none";
document.getElementById("OrderNumber").style.display = "none";
document.getElementById("All_Records").style.display = "none";
document.getElementById("AllOrders").style.display = "none";
            ...
            document.getElementById("ManifestOrders").style.display = "none";
        document.getElementById("YesterdayOrders").style.display = "block";
...
document.getElementById("All_Records").style.display = "none";
            ...
            document.getElementById("YesterdayOrders").style.display = "none";
            document.getElementById("AllOrders").style.display = "none";
        document.getElementById("ManifestOrders").style.display = "block";
    }else{
document.getElementById("AWBNumber").style.display = "none";
document.getElementById("OrderNumber").style.display = "none";
document.getElementById("All_Records").style.display = "none";
...
<div class="row" id="TodayOrders" style="display:none;">
    <a href="OrderaAllExcela/Today_Orders.php?OrderManageBy=Today" class="btn btn-link" style="font-size:15px;color:#595959;border-radius:20px">Download Today Orders</a>
</div>
<!-- 24/Today Orders  End-->
<!-- Yesterday Orders Start -->
<div class="row" id="YesterdayOrders" style="display:none;">
    <a href="OrderaAllExcela/Yesterday_Orders.php?OrderManageBy=Today" class="btn btn-link" style="font-size:15px;color:#595959;border-radius:20px">Download Yesterday Orders</a>
</div>
<!-- Yesterday Orders  End-->
<!-- This Month Orders Start -->
<div class="row" id="CurrentMonth" style="display:none;">
    <a href="OrderaAllExcela/Current_Month.php?OrderManageBy=Current" class="btn btn-link" style="font-size:15px;color:#595959;border-radius:20px">Download Current Month Order</a>
</div>
<!-- This Month Orders End -->
<!-- Last Month Orders Start -->
<div class="row" id="LastMonth" style="display:none;">
    <a href="OrderaAllExcela/Last_Month.php?OrderManageBy=Last" class="btn btn-link" style="font-size:15px;color:#595959;border-radius:20px">Download Last Month Order</a>
</div>
...
<div class="row" id="AllOrders" style="display:none;">
    <!-- <form action="Ordera_All_Excel.php" action="POST"> -->
         <div class="col-md-12">
              <a href="OrderaAllExcela/All_Orders.php?OrderManageBy=Custom" class="btn btn-link" style="font-size:15px;color:#595959;border-radius:20px">Download All Orders</a>
...
<div class="row" id="CustomOrders" style="display:none;">
    <form action="OrderaAllExcela/Custome_Range.php" action="POST">
        <div class="col-md-2 col-sm-2 text-right"><h5><strong>From</strong></h5></div>
        <div class="col-md-10 col-sm-10 text-left">
            <input type="date" name="startdatefrom" class="form-control" style="border-radius:20px" required="">
        </div>
        &ensp;<br>
        <div class="col-md-2 col-sm-2 text-right"><h5><strong>To</strong></h5></div>
        <div class="col-md-10 col-sm-10 text-left">
            <input type="date" name="enddatefrom" class="form-control" style="border-radius:20px" required="">
        </div>
        &ensp;
...
<!-- Custom Orders End -->
<!-- Manifest / NotPicked Orders Start -->
<div class="row" id="ManifestOrders" style="display:none;">
    <a href="OrderaAllExcela/Manifest_Orders.php?OrderManageBy=Today" class="btn btn-link" style="font-size:15px;color:#595959;border-radius:20px">Download Manifest Orders</a>
</div>
<!-- Manifest / NotPicked Orders  End-->
<!-- Order Number Start -->
