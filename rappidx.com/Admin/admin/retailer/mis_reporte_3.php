...
$date2 = strtotime("$crttime");
$diff = abs($date2 - $date1);
if($diff<7200){  $upcrttime = $lastuploadtime; }else{  $upcrttime = date("H:i:s");  }
// Time InterVal Same Between 5 Minute Gap
// $upcrttime = date("H:i:s");
...
'$value[37]','$value[8]','$value[16]','$userd[Company_Name]','$crtdata[Mobile]',
...
'$crtdata[User_Id]','$value[1]','$crtdata[Item_Name]','$value[2]','$value[8]','$statushow',
