...
echo $livequery1 = "SELECT * FROM `spark_single_order` WHERE `Awb_Number`!='' AND `orderno`!='' AND `awb_gen_by`!=''  AND (`User_Id`!='' AND `User_Id`!=0) AND (`order_cancel`!='1' OR `order_cancel` IS NULL) AND `order_status_show`!='Upload' AND (`order_status_show`!='Delivered' AND `order_status_show`!='RTO Delivered') ORDER BY RAND() LIMIT 100";
...
$query123 = "INSERT INTO `testing_cronjob`(`name`, `crtdate`, `count`) VALUES ('Admin',now(),'3')";
