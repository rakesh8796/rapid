...
<div class="table-responsive">
  ...
  <div class="col-md-12 text-left">
        <div class="col-md-3 col-sm-3"><span style="font-size:18px"><u><b>RTO Orders</b></u></span></div>
        <div class="col-md-3 col-sm-3"></div>
        <div class="col-md-3 col-sm-3"></div>
        <div class="col-md-3 col-sm-3">
            <a href="OrderaAllExcel/Client_RTO_Orders.php" class="btn btn-default" style="border-radius:20px;background:#5A5A5A;color:#fff;width:90%">Download</a>
        </div>
  </div><br>&ensp;
  <!-- Excel File -->
