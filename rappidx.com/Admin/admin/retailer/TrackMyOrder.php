...
<div class="row bg-title">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4 class="page-title">Order Tracking/Real Time</h4>
  </div>
</div>
        ...
        <div class="row m-t-10">
            <div class="col-md-12">
                <div class="input-group">
                    <textarea rows="5" class="form-control" name="airwaybillnumber" id="airwaybillnumber" placeholder="Search Order Details Write AWB Number"></textarea>
                </div>
            </div>
        </div>
