...
// error_reporting(1);
$filename=$username."Last 7 Days Order";
...
<!--  -->
<?php
    $singleproquery = "SELECT * FROM `spark_single_order` WHERE `User_Id`='$user_id' AND `Awb_Number`!='' AND `Rec_Time_Stamp`>now() - INTERVAL 7 day";
