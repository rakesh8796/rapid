...
$query="UPDATE `spark_wallet_details` SET `currency`='$crncy',`amount`='$amt',`txn_date_time`='$txndate',`txnid`='$txnid',`banktxnid`='$banktxnid',`status`='$status' WHERE `order_id`='$orderid'";
