...
// Amount Details
echo $query1 = "SELECT * FROM `spark_wallet_details` WHERE `user_id`='$useridisa' ORDER BY `wallet_id` desc";
...
echo $query="INSERT INTO `spark_wallet_details`(`user_id`, `order_id`,`currency`, `amount`, `txn_date_time`, `txnid`, `status`, `last_amt`, `update_amt`, `crt_amt`) VALUES('$useridisa','$orderid','$crncy','$amt','$txndate','$txnid','$status','$lastamt','$amt','$finalamt')";
