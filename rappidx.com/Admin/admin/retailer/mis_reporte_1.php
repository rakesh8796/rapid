...
<form method="post" enctype="multipart/form-data">
    <div class="col-md-3">
        <input type="file" name="bulkorderfile" required="" style="width:100%">
    </div>
    <div class="col-md-3">
...
if($ext!="csv"){
  echo "<script> window.location.assign('mis_reporte.php?excelfile=CSV Required')</script>";
}
// File Extention Check
...
if($value[4]=="Delivered" AND $value[5]=="RTO"){
  ...
  if($value[4]=="RTO" OR $value[4]=="Delivered"){
    ...
    $statushow = "In Transit";
  }elseif($value[4]=="CSAW Pending" OR $value[4]=="CSAW" OR $value[4]=="Re-Attempt" OR $value[4]=="Undelivered" OR $value[4]=="Not Delivered"){
...
if($value[26]=="RTD"){
  ...
  if($value[26]=="RTO" OR $value[26]=="Delivered"){
    $statushow = "RTO Delivered";
  }elseif($value[26]=="ConnectionPending" OR $value[26]=="In Transit" OR $value[26]=="LH Fwd Intransit"){
    $statushow = "In Transit";
  }elseif($value[26]=="CSAW Pending" OR $value[26]=="CSAW" OR $value[26]=="Re-Attempt" OR $value[26]=="Undelivered" OR $value[26]=="Not Delivered"){
    $statushow = "Undelivered";
...
'','','','$value[5]','$value[4]',
'$value[7]','$value[6]','$userd[Company_Name]','$userd[Reg_Mobile]','$crtdata[Name]',
'','','$orderageing','','DTDC',
'','','','','',
'$tudate','$upcrttime')";
mysqli_query($conn,$singlequery);
...
'$value[18]','$userd[Company_Name]','$userd[Reg_Mobile]','$crtdata[Name]','$value[7]',
