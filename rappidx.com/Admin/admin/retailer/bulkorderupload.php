...
$beartokn = "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..Z__eGI5hrHd7s4SnRqCGlUQK938IXy0Jb5b-_o9KRbsPDIMcm7DoeaiGhvmEs2Mo4vDZzWf85yizulrOaH7WqgSNtr4RyCXG1mBACdha5QhRl8bfcO5AMJybo6o-Se5QbMZ-lEpFCHhDBFNVvKUxWa-rZAbNb4GOc7abWWrh-Z-eVFNyA5fibFKuVXOgot4nk4MHCK-NuCeTJ4gIaFQLxx5MaSI8E4hxCNed2OVFA8npPWCNDFl4Ct0OJCpZsiLSqIos8LPotv8dtDofgxk7rB3XdX0m-nn4p4bOdohRpaZjQZUKxb0sEfDrdjHupKU54uqh7BSrDOeyeKl-bp9-6A";
...
if($response['unauthorised']){
    ...
    // print_r($response);
    // echo "<br> :- ";
    // echo $response['response'][0]['tracking_id'];
    // echo "<br> :- ";
