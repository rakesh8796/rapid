        ...
        <div class="">
          ...
          <div class="">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                  <h5 class="fontweighlight" style="background-color:#33333373;padding:5px">BD Orders Report (Last 10 Days)
...
$(document).ready(function(){
  ...
  $.ajax({
  type: "GET",
  url: 'misreportsasorders/amis.php',
  data:{val:"Today "},
...
) VALUES ('Bluedart','$bannername','$tudate','$crttime','$crtdatetime','$user_id','$user_id','$user_id','$user_id','2')";
mysqli_query($conn,$singlequery);
