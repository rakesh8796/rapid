...
<form method="post">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control  form-control-lg" name='username' id='username' placeholder="E-mail">
        </div>
    </div>
    <div class="form-group">
    ...
    <!-- <div class="form-group">
        <input type="submit" onclick="showallordershere()" name="Login" id="Login" value="Log In" class="btn btn-primary btn-block"/>
    </div> -->
    <!-- <center>
        <a href="forgot_password.html" id="forgot" class="forgot" style="color:blue"> Forgot Password? </a>
    </center> -->
    <input type="submit" name="loginchekc" value="Login" class="btn btn-primary btn-block">
</form>
