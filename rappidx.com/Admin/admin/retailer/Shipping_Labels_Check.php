...
<textarea rows="5" class="form-control" name="shippinglabelawbno" placeholder="AWB Number (Use New Line Between 2 AWB Numbers) [Max-999]    [ Please Not Use  Comma(,) And Space( ) ]" required=""><?= $awbordernos ?></textarea>
