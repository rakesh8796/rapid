...
<div class="row bg-title fontweigh">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4 class="text-center">
        <span style="float:left">Client Registration</span>
            <?php
            if(@$_GET['msg']=="y")
            {
                echo "<span style='color:green' class='text-center'>Registration Complete</span>";
            }elseif(@$_GET['msg']=="n")
            {
                echo "<span style='color:red' class='text-center'>Registration Not Complete</span>";
            }else
            {
                echo "<span class='text-center'>ONBOARDING FORM</span>";
            }
            ?>
...
<form class="grid-form" enctype="multipart/form-data"  method="post" action="Client_Registration_Web.php">
    ...
    <fieldset>
        ...
        <div data-row-span="1">
            <div data-field-span="1">
                ...
                <input type="text" name="companyname" value="<?= $companyname ?>" required="" autofocus>
            </div>
        </div>
    </fieldset>
    <fieldset>
        ...
        <div data-row-span="4">
            ...
            <div data-field-span="1">
                ...
                <input type="text" name="Email" value="<?= $emailid ?>" required="">
            </div>
            <div data-field-span="1">
        ...
        <fieldset>
            ...
            <div data-row-span="5">
                ...
                <div data-field-span="1">
                    <label>Mobile</label>
                    <input type="text" name="regmobile" value="<?= $mobile ?>" required="">
                </div>
                <div data-field-span="1">
...
<fieldset>
            ...
            <div data-row-span="4">
                <div data-field-span="1">
                    ...
                    <input type="text" name="clientauth" value="<?= $clientname ?>" required="">
                </div>
                <div data-field-span="1">
                ...
                <div data-field-span="1">
                    <label>Email</label>
                    <input type="text" name="clientemail" value="<?= $emailid ?>" required="">
                </div>
                <div data-field-span="1">
                    <label>Mobile</label>
                    <input type="text" name="clientmobile" value="<?= $mobile ?>" required="">
                </div>
            </div>
            <div data-row-span="4">
                <div data-field-span="1">
...
<br><br>
 ...
 <div class="modal-footer">
    <center>
        <input type="hidden" name="websitejoinid" value="<?= $websitejoinid ?>">
...
// *    *   *   Main/500Gm   *   *   *   Start
$query = "INSERT INTO `asitfa_user`(`usertype`,

`Company_Name`,`Website`,`Brand`,`Email`,`Pan`,`Tan`,`GST_No`,

`Reg_Address`,`Reg_City`,`Reg_Pin`,`Reg_Mobile`,`Reg_Landline`,

`Com_Address`,`Com_City`,`Com_Pin`,`Com_Mobile`,`Com_Landline`,

`Bankname`,`Bankaccount`,`Branch`,`IFSC`,`Acc_Type`,

`Product`,`Service`,`Pickup`,`Cod_Rem`,`Billing_Type`,`Billing_Cycle`,`remittancecycle`,`commercialstype`,
...
`User_Email`,`User_Password`,`User_Password_show`,

`Client_Auth`,`Designation`,`Client_Email`,`Client_Mobile`,

`Client_poc`,`Poc_Designation`,`Poc_Email`,`Poc_Mobile`,

`Operation_Poc`,`Operation_Designation`,`Operation_Mail`,`Operation_Mobile`,

`Bd_Name`,`Bd_Designation`,`Bd_mail`,`Bd_Mobile`,

`Pancard`,`GST_cert`,`Can_Cheque`,`Add_Proofe`,`Client_Mail_acc`,`foldername`,`Rec_Time_Stamp`,`Active`,`added_by`
) VALUES (
'client',

'$companyname','$website','$brand','$Email','$pan','$tan','$gstno',

'$regaddress','$regcity','$regpin','$regmobile','$reglandline',

'$comaddress','$comcity','$compin','$commobile','$comlandline',

'$bankname','$bankacc','$branch','$ifsc','$acctype',

'$product','$service','$pickup','$codrem','$billingtype','$billingcycle','$remittancecycle','gm500',
...
'$clientid','$password','$oripassword',

'$clientauth','$designation','$clientemail','$clientmobile',

'$clientpoc','$pocdesignation','$pocemail','$pocmobile',

'$operationpoc','$operationdesignation','$operationemail','$operationmobile',

'$bdname','$bddesignation','$bdemail','$bdmobile',

'$uploadimagename','$gstcername','$canchequename','$addproofename','$clientmailaccname','$foldername',now(),'1','Admin')";
...
// Website Details
mysqli_query($conn,"UPDATE `asitfa_user_website` SET `formstatus`='Complete',`userid`='$last_id0',`useridshow`='$useruinqueidnois0',`joindate`=now() WHERE `websitejoinid`='$websitejoinid'");
// Website Details
...
//     $mail->send();
//  *   *   *    Mail Send To Client *  *   *
    echo "<script>window.location.assign('Website_All.php?msg=y')</script>";
}catch (Exception $e) {
    echo "<script>window.location.assign('Website_All.php?msg=n')</script>";
}
