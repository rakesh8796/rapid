...
<div class="col-md-12 white-box">
    <div class="col-md-12">
        <span class="fontweighlight">New Retailer Register</span>
    </div>
</div>
...
<style>
    ...
    input{ color:#333158;}
    select,option{color:#333158;}
</style>


<form class="grid-form" enctype="multipart/form-data"  method="post" action="Retailer_Registration.php">
<h2 class="text-center">

<?php
if(@$_GET['msg']=="y")
{
    echo "<span style='color:green'>Retailer account created</span>";
}elseif(@$_GET['msg']=="n")
{
    echo "<span style='color:red'>Retailer account not created</span>";
}else
{
    echo "Create new retailer account";
}
?>
</h2>
...
$(document).ready(function(){
    $("#Personaldetailsac").click(function(){
        $("#Personaldetails").toggle();
    });
    
    $("#CommunicationAddressandBank").hide();
    $("#CommunicationAddressandBankac").click(function(){
        $("#CommunicationAddressandBank").toggle();
    });
    
    $("#procductare").hide();
    $("#procductareac").click(function(){
        $("#procductare").toggle();
    });
    
    $("#remittancecommercials").hide();
    $("#remittancecommercialsac").click(function(){
        $("#remittancecommercials").toggle();
    });
    
    $("#clientidare").hide();
    $("#clientidareac").click(function(){
        $("#clientidare").toggle();
    });
    
    $("#attachdocument").hide();
    $("#attachdocumentac").click(function(){
        $("#attachdocument").toggle();
    });
});
</script>
<!---->
...
<div class="panel-heading" style="padding:0px !important">
    <h3 class="panel-title text-left fontweighlight pointer" style="font-size:15px !important;background:#b5b5b5;border-radius:5px;color:#333131;padding:0px 0px 0px 10px" id="Personaldetailsac"> Personal Details 
        <span class="float:right">+</span>
    </h3>
</div>
<div class="panel-heading" style="background-color:#b5b5b53b" id="Personaldetails">
<!---->
    <fieldset>
        <legend></legend>
        <div data-row-span="1">
...
<div class="panel white-box1" style="background:#fff;color:white !important;padding:0px">
<div class="panel-heading" style="padding:0px !important">
    <h3 class="panel-title text-left fontweighlight pointer" style="font-size:15px !important;background:#b5b5b5;border-radius:5px;color:#333131;padding:0px 0px 0px 10px" id="CommunicationAddressandBankac"> Communication Address & Bank Details
        <span class="float:right">+</span>
    </h3>
</div>
<div class="panel-heading" style="background-color:#b5b5b53b" id="CommunicationAddressandBank">
<!---->
...
<div class="panel white-box1" style="background:#fff;color:white !important;padding:0px">
<div class="panel-heading" style="padding:0px !important">
    <h3 class="panel-title text-left fontweighlight pointer" style="font-size:15px !important;background:#b5b5b5;border-radius:5px;color:#333131;padding:0px 0px 0px 10px" id="procductareac"> Product Details
        <span class="float:right">+</span>
    </h3>
</div>
<div class="panel-heading" style="background-color:#b5b5b53b" id="procductare">
<!---->
...
<div class="panel white-box1" style="background:#fff;color:white !important;padding:0px">
<div class="panel-heading" style="padding:0px !important">
    <h3 class="panel-title text-left fontweighlight pointer" style="font-size:15px !important;background:#b5b5b5;border-radius:5px;color:#333131;padding:0px 0px 0px 10px" id="remittancecommercialsac"> Commercials Details
        <span class="float:right">+</span>
    </h3>
</div>
<div class="panel-heading" style="background-color:#b5b5b53b" id="remittancecommercials">
<!---->
<!--  -->
    ...
    <div data-field-span="1">
        <label>
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <span style="float:left;font-size:21px;margin-top: 2px !important;"><b>T+</b></span>
...
<!-- 500 GM -->
    <div id="gm500" class="city">
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="min_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="min_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="min_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="min_f">
            </div>
        </div>
        ...
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="add_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="add_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="add_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="add_f">
            </div>
        </div>
<!--  -->
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="rto_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto_f">
            </div>
        </div>
...
<!-- 1 KG -->
    <div id="kg1" class="city" style="display:none">
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="min1_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min1_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="min1_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min1_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="min1_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min1_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="min1_f">
            </div>
        </div>
        <div data-row-span="12">
            <div data-field-span="2">
            ...
            <div data-field-span="1">
                <input type="text" name="add1_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add1_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="add1_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add1_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="add1_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add1_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="add1_f">
            </div>
        </div>
<!--  -->
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="rto1_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto1_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto1_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto1_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto1_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto1_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto1_f">
            </div>
        </div>
        <div data-row-span="2">
            <div data-field-span="1">
...
<!-- 2 KG -->
    <div id="kg2" class="city" style="display:none">
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="min2_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min2_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="min2_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min2_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="min2_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min2_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="min2_f">
            </div>
        </div>
        <div data-row-span="12">
            <div data-field-span="2">
            ...
            <div data-field-span="1">
                <input type="text" name="add2_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add2_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="add2_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add2_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="add2_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add2_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="add2_f">
            </div>
        </div>
<!--  -->
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="rto2_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto2_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto2_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto2_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto2_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto2_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto2_f">
            </div>
        </div>
...
<!-- 5 KG -->
    <div id="kg5" class="city" style="display:none">
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="min5_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min5_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="min5_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min5_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="min5_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min5_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="min5_f">
            </div>
        </div>
        <div data-row-span="12">
            <div data-field-span="2">
            ...
            <div data-field-span="1">
                <input type="text" name="add5_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add5_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="add5_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add5_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="add5_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add5_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="add5_f">
            </div>
        </div>
<!--  -->
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="rto5_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto5_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto5_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto5_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto5_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto5_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto5_f">
            </div>
        </div>
...
<!-- 10 KG -->
    <div id="kg10" class="city" style="display:none">
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="min10_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min10_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="min10_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min10_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="min10_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="min10_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="min10_f">
            </div>
        </div>
        <div data-row-span="12">
            <div data-field-span="2">
            ...
            <div data-field-span="1">
                <input type="text" name="add10_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add10_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="add10_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add10_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="add10_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="add10_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="add10_f">
            </div>
        </div>
<!--  -->
        <div data-row-span="12">
            ...
            <div data-field-span="1">
                <input type="text" name="rto10_b1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto10_c">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto10_c1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto10_d">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto10_d1">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto10_e">
            </div>
            <div data-field-span="1">
                <input type="text" name="rto10_f">
            </div>
        </div>
...
<div class="panel white-box1" style="background:#fff;color:white !important;padding:0px">
<div class="panel-heading" style="padding:0px !important">
    <h3 class="panel-title text-left fontweighlight pointer" style="font-size:15px !important;background:#b5b5b5;border-radius:5px;color:#333131;padding:0px 0px 0px 10px" id="clientidareac"> Client Id Details
        <span class="float:right">+</span>
    </h3>
</div>
<div class="panel-heading" style="background-color:#b5b5b53b" id="clientidare">
<!---->
            ...
            <div data-row-span="2">
                <div data-field-span="1" class="input-container">
                    ...
                    <span class="icon" style="margin-top: -30px !important;">@rappidx.com</span>
                </div>
                <div data-field-span="1">
...
<div class="panel white-box1" style="background:#fff;color:white !important;padding:0px">
<div class="panel-heading" style="padding:0px !important">
    <h3 class="panel-title text-left fontweighlight pointer" style="font-size:15px !important;background:#b5b5b5;border-radius:5px;color:#333131;padding:0px 0px 0px 10px" id="attachdocumentac"> Attach Document Details
        <span class="float:right">+</span>
    </h3>
</div>
<div class="panel-heading" style="background-color:#b5b5b53b" id="attachdocument">
<!---->
            ...
            <div data-row-span="3">
                ...
                <div data-field-span="1">
                    ...
                    <input id="input-41" type="file" name="gstcert" class="form-control file-loading">
                </div>
                <div data-field-span="1">
                    <label>Cancel Cheque</label>
                    <input id="input-41" type="file" name="cancheque" class="form-control file-loading">
                </div>
            </div>
            <div data-row-span="2">
                <div data-field-span="1">
                    <label>Address Proof</label>
                    <input id="input-41" type="file" name="addproofe" class="form-control file-loading">
                </div>
                <div data-field-span="1">
                    <label>Client’s Mail Acceptance (commercials)</label>
                    <input id="input-41" type="file" name="clientmailacc" class="form-control file-loading">
                </div>
            </div>
...
`Min_a`, `Min_b`, `Min_b1`, `Min_c`, `Min_c1`, `Min_d`, `Min_d1`, `Min_e`, `Min_f`, 
`Add_a`, `Add_b`, `Add_b1`, `Add_c`, `Add_c1`, `Add_d`, `Add_d1`, `Add_e`, `Add_f`, 
`Rto_a`, `Rto_b`, `Rto_b1`, `Rto_c`, `Rto_c1`, `Rto_d`, `Rto_d1`, `Rto_e`, `Rto_f`,
`FSC`,`COD`,`Shipment_Lia`,`GST`,`specialnotes`,

`min1_a`,`min1_b`,`min1_c`,`min1_d`,`min1_e`,
`add1_a`,`add1_b`,`add1_c`,`add1_d`,`add1_e`,
`Rto1_a`,`Rto1_b`,`Rto1_c`,`Rto1_d`,`Rto1_e`,`FSC1`,`COD1`,`Shipment_Lia1`,`GST1`,`specialnotes1`,

`min2_a`,`min2_b`,`min2_c`,`min2_d`,`min2_e`,
`add2_a`,`add2_b`,`add2_c`,`add2_d`,`add2_e`,
`Rto2_a`,`Rto2_b`,`Rto2_c`,`Rto2_d`,`Rto2_e`,`FSC2`,`COD2`,`Shipment_Lia2`,`GST2`,`specialnotes2`,

`min5_a`,`min5_b`,`min5_c`,`min5_d`,`min5_e`,
`add5_a`,`add5_b`,`add5_c`,`add5_d`,`add5_e`,
`Rto5_a`,`Rto5_b`,`Rto5_c`,`Rto5_d`,`Rto5_e`,`FSC5`,`COD5`,`Shipment_Lia5`,`GST5`,`specialnotes5`,

`min10_a`,`min10_b`,`min10_c`,`min10_d`,`min10_e`,
`add10_a`,`add10_b`,`add10_c`,`add10_d`,`add10_e`,
...
'$add_a','$add_b','$add_b1','$add_c','$add_c1','$add_d','$add_d1','$add_e','$add_f',
'$rto_a','$rto_b','$rto_b1','$rto_c','$rto_c1','$rto_d','$rto_d1','$rto_e','$rto_f',
'$fsc','$cod','$shipmentlia','$gst','$specialnote',
...
//  *   *   *    Mail Send To Client *  *   *
    ...
    // echo "<br>Last If Condition<br>";
    echo "<script>window.location.assign('Retailer_Registration.php?msg=y')</script>";
    // echo "<br>Last If Condition<br>";

}catch (Exception $e) {

    // echo "<br>Last Else Condition<br>";
    echo "<script>window.location.assign('Retailer_Registration.php?msg=n')</script>";
    // echo "<br>Last Else Condition<br>";
...
//     $useruinqueidnois = "RPXC".$last_id;
//     $uniquequery = "UPDATE `asitfa_user` SET `useruinqueidno`='$useruinqueidnois' WHERE `User_Id`='$last_id'";
//     mysqli_query($conn,$uniquequery);
