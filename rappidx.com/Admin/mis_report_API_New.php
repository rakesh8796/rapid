...
`Last_Time_Stamp`='$value[6]',`pickupdate`='$value[3]',`deliverydate`='$value[7]',`rtodate`='$value[24]',
`order_status1`='$value[4]',`order_status`='$value[5]',`order_status_show`='$statushow',`attemptcount`='$value[22]' 
