...
<input type="number" min="0.1" name="actualweight" id="actualweight" class="form-control phone-number">
...
<!--                    <div class="input-group">-->
<!--<select name="servicestype" id="servicestype" class="form-control" required="">-->
...
<input type="text" name="productamount" min="0" onkeyup="precheckcalculaterate()" id="productamount" class="form-control phone-number">
        ...
        <div class="row">
            <div class="my-0 col-md-6  ">
                <div class="row">
                    <div class="col-md-6">
                        <a href="#" class="btn btn-primary form-control" data-toggle="modal" data-target="#basicModal" onclick="calculaterate()">&nbsp;Calculate</i></a>
                    </div>
                    <div class="col-md-6">
...
<!-- <tr>
<td><img src="img/couriers/bluedart-logo.png" style="width:50px"></td>
<td>Upto 250 Gram</td>
<td>30</td>
<td>36</td>
<td>43</td>
...
<!-- <tr>
<td><img src="img/couriers/dtdc-logo.png" style="width:50px"></td>
<td>Upto 250 Gram</td>
<td>29</td>
<td>36</td>
<td>40</td>
...
<tr>
<td><img src="img/couriers/delhivery-logo.png" style="width:50px;background:black"></td>
<td>Upto 250 Gram</td>
<td>44</td>
<td>50</td>
<td>63</td>
...
<tr>
<td><img src="img/couriers/ekart-logo.png" style="width:50px"></td>
<td>Upto 250 Gram</td>
<td>35</td>
<td>41</td>
<td>48</td>
...
<tr>
<td><img src="img/couriers/xprssbees-logo.png" style="width:50px"></td>
<td>Upto 250 Gram</td>
<td>58</td>
<td>66</td>
<td>75</td>
...
function calculaterate(){
    ...
    var distancebtwnkm = parseInt($("#distancebtwnkm").val());
...
<div class="row">
    ...
    <div class="col-md-6">
        <strong>Delivery Pincode : </strong><span id="destinpinno"> <span> <br>
    </div>
</div>
<br>
<div my-3>
    <strong>Sevice Between : </strong><span id="servicebtwn"> <span> 
</div>

<div class="row">
    <div class="col-md-6">
        <strong>Distance : </strong><span id="distncebtwn"> <span> 
    </div>
    <div class="col-md-6">
        <strong>Zone : </strong><span id="zonebtwn"> <span> 
    </div>
</div>
