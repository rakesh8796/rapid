           ...
           <form class="form-horizontal" role="form" id="popup-validation" method="post" action="Paytm/PaytmKit/pgRedirect.php" target="_blank">
             ...
             <div class="text-center ">
               <div class="row my-4">
                 ...
                 <div class="col-md-6">
                   <input type="text" placeholder="₹" class="form-control" style="border-color:#33333373;border-radius:20px" value="" name="TXN_AMOUNT" id="first-name" placeholder="0.0">
               ...
               <div class="text-center my-3">
                 <a href="#" class="btn btn-primary badge pic_amount">500</i></a>
                 <a href="#" class="btn btn-primary badge pic_amount">1000</i></a>
                 <a href="#" class="btn btn-primary badge pic_amount">2000</i></a>
                 <a href="#" class="btn btn-primary badge pic_amount">5000</i></a>
                 <a href="#" class="btn btn-primary badge pic_amount">10000</i></a>
               </div>
