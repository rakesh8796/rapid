...
<thead style="background-color:#243c4f;color:#60baaf">
  <tr>
    <th style="border-right:1px solid #41AEAF;color:#fff">Shipping ID</th>
    <th style="border-right:1px solid #41AEAF;color:#fff">Type</th>
    <th style="border-right:1px solid #41AEAF;color:#fff">Status</th>
    <th style="border-right:1px solid #41AEAF;color:#fff">Current Location</th>
    <th style="border-right:1px solid #41AEAF;color:#fff">Status_Date/Time</th>
...
<thead style="background-color:#243c4f;color:#60baaf">
  <tr>
    ...
    <th style="border-right:1px solid #41AEAF;color:#fff">Current Location</th>
    <th style="border-right:1px solid #41AEAF;color:#fff">Status_Date/Time</th>
    <th style="border-right:1px solid #41AEAF;color:#fff">Destination</th>
    <th style=""></th>
  </tr>
</thead>
<tbody>
