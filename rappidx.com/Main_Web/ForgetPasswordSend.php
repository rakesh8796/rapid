...
<h2> Forgot Password </h2>
    ...
    <div class="" style="font-size:18px;color:white">
          An email has been sent to <u><?= $forgetemail ?></u> email address to reset password.Please Check Your Email
        <div class="clear"></div>
        <br>
    </div>
...
<div class="w3layouts_more-buttn">
    ...
    <!--<h2><a href="NewPassword.php?useremail=<?= $forgetemail ?>"> Reset Password</a></h2>-->
</div>
